...
class VibreytePage extends StatefulWidget {
  const VibreytePage({Key? key}) : super(key: key);

  @override
  _VibreytePageState createState() => _VibreytePageState();
}

class _VibreytePageState extends State<VibreytePage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('Vibrate Example')),
        body: Center(
